...
<label>Enter the product name</label> <br><br>
<input type="text" name="pname" required><br>
<label>Status</label> <br><br>
<input type="radio" id="status" name="status" value="Y"> IN STOCK  
<br>  
<input type="radio" id="status" name="status" value="N"> OUT OF STOCK <br/>   
